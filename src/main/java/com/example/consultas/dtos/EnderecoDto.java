...
public record EnderecoDto(UUID id, @NotBlank String uf, @NotBlank String cidade, @NotBlank String cep, @NotBlank String bairro,
                          @NotBlank String rua, @NotBlank String numero, boolean principal) {

    public EnderecoDto(EnderecoModel endereco) {
        this(endereco.getId(), endereco.getUf(), endereco.getCidade(), endereco.getCep(),  endereco.getBairro(), endereco.getRua(), endereco.getNumero(), endereco.getPrincipal());
    }

    public EnderecoModel toEntity(){
        return new EnderecoModel(null, uf, cidade, cep, bairro, rua, numero, false, null);
    }
