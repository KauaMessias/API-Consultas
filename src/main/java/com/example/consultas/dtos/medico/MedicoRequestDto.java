...
public record MedicoRequestDto(@NotBlank String nome, @NotBlank @Pattern(regexp = "\\d+") String crm,
                               ...
                               @NotBlank @Pattern(regexp = "^(\\d{10,11})$") String telefone, @NotBlank String especialidade) {


    public MedicoModel toEntity(){
        return new MedicoModel(null, nome, crm, telefone, especialidade, null, null, null);
    }
