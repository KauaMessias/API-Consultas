...
public record ConsultaDto(UUID id, @NotNull @Future LocalDateTime dataConsulta, @NotBlank String tipoConsulta, @NotBlank String descricaoConsulta, @NotNull UUID medicoId, @NotNull UUID clienteId) {
