    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity, CorsConfigurationSource corsConfigurationSource) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/auth/recuperarSenha/**").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/v1/auth/enviarRecuperacao/**").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/v1/auth/validarCadastro/**").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/v1/auth/reenviarValidacao/**").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/clientes").hasAnyRole("ADMIN")
